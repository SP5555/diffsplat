                     ...
                     int sh_degree)
{
    ...
    up(params.pos_x,         [](const Gaussian3D& g) { return g.x; });
    up(params.pos_y,         [](const Gaussian3D& g) { return g.y; });
    up(params.pos_z,         [](const Gaussian3D& g) { return g.z; });
    ...
    up(params.color_sh_r,    [](const Gaussian3D& g) { return g.r; });
    up(params.color_sh_g,    [](const Gaussian3D& g) { return g.g; });
    up(params.color_sh_b,    [](const Gaussian3D& g) { return g.b; });
    up(params.logit_opacity, [](const Gaussian3D& g) { return g.opacity; });
...
std::vector<Gaussian3D> downloadGaussians(const Gaussian3DParams& params)
{
    ...
    dn(params.pos_x,         [](Gaussian3D& g, float v) { g.x       = v; });
    dn(params.pos_y,         [](Gaussian3D& g, float v) { g.y       = v; });
    dn(params.pos_z,         [](Gaussian3D& g, float v) { g.z       = v; });
    ...
    dn(params.color_sh_r,    [](Gaussian3D& g, float v) { g.r       = v; });
    dn(params.color_sh_g,    [](Gaussian3D& g, float v) { g.g       = v; });
    dn(params.color_sh_b,    [](Gaussian3D& g, float v) { g.b       = v; });
    dn(params.logit_opacity, [](Gaussian3D& g, float v) { g.opacity = v; });
