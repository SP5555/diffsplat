...
however, $H \in \mathbb{R}^{2\times2}$ is the symmetric matrix of upstream gradients:

$$H = \begin{bmatrix} \partial L/\partial\sigma_{xx}^{2D} & h \\ h & \partial L/\partial\sigma_{yy}^{2D} \end{bmatrix}, \qquad h = \frac{1}{2}\,\frac{\partial L}{\partial\sigma_{xy}^{2D}}$$
...
$$\frac{\partial L}{\partial \sigma_{xx}} = J_{00}^2\,\partial\sigma_{xx}^{2D} + J_{00}J_{10}\,\partial\sigma_{xy}^{2D} + J_{10}^2\,\partial\sigma_{yy}^{2D}$$

$$\frac{\partial L}{\partial \sigma_{xy}} = J_{00}J_{01}\,\partial\sigma_{xx}^{2D} + h\!\left(J_{00}J_{11} + J_{10}J_{01}\right) + J_{10}J_{11}\,\partial\sigma_{yy}^{2D}$$

$$\frac{\partial L}{\partial \sigma_{xz}} = J_{00}J_{02}\,\partial\sigma_{xx}^{2D} + h\!\left(J_{00}J_{12} + J_{10}J_{02}\right) + J_{10}J_{12}\,\partial\sigma_{yy}^{2D}$$

$$\frac{\partial L}{\partial \sigma_{yy}} = J_{01}^2\,\partial\sigma_{xx}^{2D} + J_{01}J_{11}\,\partial\sigma_{xy}^{2D} + J_{11}^2\,\partial\sigma_{yy}^{2D}$$

$$\frac{\partial L}{\partial \sigma_{yz}} = J_{01}J_{02}\,\partial\sigma_{xx}^{2D} + h\!\left(J_{01}J_{12} + J_{11}J_{02}\right) + J_{11}J_{12}\,\partial\sigma_{yy}^{2D}$$

$$\frac{\partial L}{\partial \sigma_{zz}} = J_{02}^2\,\partial\sigma_{xx}^{2D} + J_{02}J_{12}\,\partial\sigma_{xy}^{2D} + J_{12}^2\,\partial\sigma_{yy}^{2D}$$
